...
func Seed(db *gorm.DB) {
	...
	_ = UpsertStation(db, "Midtown", "dn5bptxy8r41", "Midtown Station", []models.Line{gold, red})
	_ = UpsertStation(db, "North Avenue", "dn5bpsp70th7", "North Avenue Station", []models.Line{gold, red})
	_ = UpsertStation(db, "Civic Center", "dn5bpep496h7", "Civic Center Station", []models.Line{gold, red})
	_ = UpsertStation(db, "Peachtree Center", "dn5bp9qxs9nh", "Peachtree Center Station", []models.Line{gold, red})
